(function ($) {
  ...
  jQuery(document).ready(function ($) {
      ...
      Datepicker.prototype = {
              ...
              [
                this.element,
                {
                  ...
                  keyup: $.proxy(function (e) {
                    if (
                      $.inArray(e.keyCode, [27, 37, 39, 38, 40, 32, 13, 9]) ===
                      -1
                    )
                      this.update();
                  }, this),
        ...
        fill: function () {
            ...
            if (prevMonth.getUTCDay() === this.o.weekStart) {
              ...
              if (this.o.calendarWeeks) {
                ...
                var // Start of current week: based on weekstart/current date
                  ws = new Date(
                    +prevMonth +
                      ((this.o.weekStart - prevMonth.getUTCDay() - 7) % 7) *
                        864e5
                  ),
          ...
          for (var i = -1; i < 11; i++) {
            ...
            html +=
              '<span class="' + classes.join(" ") + '">' + year + "</span>";
            year += 1;
          }
          yearCont.html(html);
        },
              ...
              if (isNaN(val)) {
                switch (part) {
                  ...
                  case "M":
                    ...
                    val =
                      $.inArray(filtered[0], dates[language].monthsShort) + 1;
                    break;
                }
              }
              parsed[part] = val;
    ...
    $(window).scroll(function () {
      var window_top = $(window).scrollTop() + 1;
      if (window_top > 30) {
        $(".Anesthesiology_header_wrapper").addClass(
          "menu_fixed animated fadeIn"
        );
      } else {
        $(".Anesthesiology_header_wrapper").removeClass(
          "menu_fixed animated fadeIn"
        );
      }
    });
    ...
    $(window).scroll(function () {
      var window_top = $(window).scrollTop() + 1;
      if (window_top > 30) {
        $(".neurology_navigation_wrapper").addClass(
          "menu_fixed animated fadeIn"
        );
      } else {
        $(".neurology_navigation_wrapper").removeClass(
          "menu_fixed animated fadeIn"
        );
      }
    });
    ...
    $(window).scroll(function () {
      ...
      if (window_top > 30) {
        ...
        $(".plumb_nav_header_wrapper").removeClass(
          "menu_fixed animated fadeIn"
        );
      }
    });
